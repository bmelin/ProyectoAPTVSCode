                        ...
                        <form action="{{ route('pacientes.guardar') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="form-select rounded-3" id="mamografia" name="Mamografia">
                                        <option value="">Selecciona</option>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select rounded-3" name="FamiliarPrimerGradoCC">
                                        <option value="">Selecciona</option>
                                        <option value="1">Sí</option>
                                        <option value="0">No</option>
                                    </select>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select rounded-3" name="FamiliarSegundoGradoCC">
                                        <option value="">Selecciona</option>
                                        <option value="1">Sí</option>
                                        <option value="0">No</option>
                                    </select>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select rounded-3" name="DiagnosticoPrevioCancer">
                                        <option value="">Selecciona</option>
                                        <option value="1">Sí</option>
                                        <option value="0">No</option>
                                    </select>
                            ...
                            <h5 class="fw-bold mb-3 text-primary">Hábitos y Antecedentes Personales</h5>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Actividad física semanal</label>
                                    <select class="form-select rounded-3" name="Ejercicio">
                                        <option value="">Selecciona</option>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select rounded-3" name="Alcohol">
                                        <option value="">Selecciona</option>
                                        <option value="nunca">Nunca</option>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select rounded-3" name="Menstruacion">
                                        <option value="">Selecciona</option>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select rounded-3" name="PrimerHijo">
                                        <option value="">Selecciona</option>
